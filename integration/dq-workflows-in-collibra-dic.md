...
{% hint style="info" %}
We've moved! To improve customer experience, the Collibra Data Quality User Guide has moved to the [Collibra Documentation Center](https://productresources.collibra.com/docs/collibra/latest/Content/DataQuality/Collibra%20DIC%20Integration/DQ%20Workflows.htm) as part of the Collibra Data Quality 2022.11 release. To ensure a seamless transition, [dq-docs.collibra.com](http://dq-docs.collibra.com/) will remain accessible, but the DQ User Guide is now maintained exclusively in the Documentation Center.
{% endhint %}
...
![Example: DQ Rule Request](<../.gitbook/assets/image (34).png>)

![Example: Manage DQ Subscriptions](<../.gitbook/assets/image (93).png>)
...
![Example: Data Quality Rule Request](<../.gitbook/assets/image (105).png>)

![Completed Rule Request Example](<../.gitbook/assets/image (94).png>)

![Example: Data Quality Rule Modification Request](<../.gitbook/assets/image (20).png>)

![Completed Data Quality Rule Modification Example](<../.gitbook/assets/image (7).png>)

![Example: DQ Synchronization Request with Rules Request optional checkbox](<../.gitbook/assets/image (56).png>)
