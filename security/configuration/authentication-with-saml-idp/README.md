...
| Property                 | Description                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CORS\_ALLOWED\_ORIGINS   | <p>Allows cross-origin requests between DQ and SAML. <br>Replace <code>${IDP-BASE-URL}</code>with the value of the actual IdP URL. For example, <code>https://ping.auth.com/</code>.<br>Replace <code>${DQ-BASE-URL}</code> with the value of the actual DQ Base URL. For example, <code>https://dq-env.com</code>.</p>                                                                                                                            |
