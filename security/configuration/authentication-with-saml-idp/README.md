...
{% hint style="info" %}
We've moved! To improve customer experience, the Collibra Data Quality User Guide has moved to the [Collibra Documentation Center](https://productresources.collibra.com/docs/collibra/latest/Content/DataQuality/SAML%20Authentication.htm) as part of the Collibra Data Quality 2022.11 release. To ensure a seamless transition, [dq-docs.collibra.com](http://dq-docs.collibra.com/) will remain accessible, but the DQ User Guide is now maintained exclusively in the Documentation Center.
{% endhint %}
...
| Property                 | Description                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CORS\_ALLOWED\_ORIGINS   | <p>Allows cross-origin requests between DQ and SAML.<br><br>Replace <code>${IDP-BASE-URL}</code>with the value of the actual IdP URL. For example, <code>https://ping.auth.com/</code>.<br><br>Replace <code>${DQ-BASE-URL}</code> with the value of the actual DQ Base URL. For example, <code>https://dq-env.com</code>.</p>                                                                                                                     |
...
| SAML\_GRANT\_ALL\_PUBLIC | <p>Whether any user authenticated by the identity provider is allowed to login the Collibra DQ application.</p><p>The default value is <code>true</code>.</p>                                                                                                                                                                                                                                                                                      |
