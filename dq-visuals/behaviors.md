...
| Action      | The [item labels](../workflows/item-labeling/) you can apply to an observation that let you train the behavioral model on future runs. Available options are Validate, Invalidate, and Resolve.                                                                  |
