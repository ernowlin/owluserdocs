...
![Figure 2: Import owl-core.jar and create new notebook](<../../.gitbook/assets/image (5).png>)
...
![Figure 3: Notebook on Azure Databricks to scan raw data](<../../.gitbook/assets/image (25).png>)
...
![Figure 4: Scorecard displayed in the output of Owl scanning the DF](<../../.gitbook/assets/image (7).png>)
...
![ Figure 6: Spark ETL / DQ Pipeline](<../../.gitbook/assets/image (1).png>)
...
![Figure 7: Stack the DQ Scores in Owl to show how we did ](<../../.gitbook/assets/image (27).png>)
