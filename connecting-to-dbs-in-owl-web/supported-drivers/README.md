...
| **SAP HANA**                     | Native                                                                            | Preview       | C+    | User / Pass             | This is not packaged with Collibra DQ containers (K8s build).  This is to be used at your own risk with standalone installs. This works with most common data types using the Spark execution. |
